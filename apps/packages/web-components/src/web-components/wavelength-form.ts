...
export class WavelengthForm<T extends object> extends HTMLElement {
  ...
  private onSubmit = (e: Event) => {
    ...
    const submitEvent =
      typeof SubmitEvent === "function" ? new SubmitEvent("submit", { bubbles: true, cancelable: true, composed: true }) : new Event("submit", { bubbles: true, cancelable: true, composed: true });
