...
const meta: Meta<typeof WavelengthSpinningLogo> = {
  title: "Content/WavelengthSpinningLogo",
  component: WavelengthSpinningLogo,
  parameters: {
    layout: "centered",
    docs: {
      page: () => (
        <>
          <h1>WavelengthSpinningLogo Documentation</h1>
          <p>
            The <code>WavelengthSpinningLogo</code> is a spinning logo
          </p>

          <h2>Usage</h2>
          <p>
            To use the <code>WavelengthSpinningLogo</code>, import it and set the desired props (svg, and size). Also <strong>download the spinning.css</strong> located below
          </p>
          <Source code="import { WavelengthSpinningLogo } from '@wavelengthusaf/components';" language="tsx" />

          <Canvas />
          <WavelengthFileDownloader fileLoc="local" fileURL="./files/spinning.txt" fileName="spinning.css" />
          <h2>Props</h2>
          <p>Here are the available props you can pass to the WavelengthNotAvailablePage:</p>
          <Controls />
        </>
      ),
    },
  ...
  tags: ["autodocs"],
} satisfies Meta<typeof WavelengthSpinningLogo>;

export default meta;

type Story = StoryObj<typeof meta>;
export const SpinningLogo: Story = {
  argTypes: {
    svg: { description: "Logo svg inside of the spining circles" },
    size: { description: "Size of spinning logo" },
  },
  args: {
    svg: mySVG,
    size: 200,
