...
function PageChildData() {
  ...
  //     }
  //     // Perform some action with the response, but no value is returned.
  ...
  const handleAddFiles = async (): Promise<void> => {
    try {
      // Simulate an asynchronous operation (e.g., file upload)
  ...
  return <ChildDataTable data={data} columns={columns} addFilesOnClick={handleAddFiles} />;
}
