...
function PageDataInputTestThree() {
...
//use iso for date
export default PageDataInputTestThree;

//commit changes and make storybook
//do jest test and cyprus test for data picker
//merge to main
